...
//
//     final leadManagement = leadManagementFromJson(jsonString);

import 'dart:convert';

List<LeadManagement> leadManagementFromJson(String str) => List<LeadManagement>.from(json.decode(str).map((x) => LeadManagement.fromJson(x)));

String leadManagementToJson(List<LeadManagement> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
